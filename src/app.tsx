      ...
      <section className="section reveal" id="problem">
        ...
        <div className="problem reveal reveal-delay-2">
          <div className="problem-copy">
            “FP&A teams in mid-market SaaS companies struggle to consolidate data from ERP, CRM, HR, billing, and product systems, resulting in manual work, spreadsheet errors, delayed reporting, and poor forecasting accuracy.”
          </div>
        </div>
      </section>
